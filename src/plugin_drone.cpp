...
namespace gazebo
{
  ...
  void DroneSimpleController::UpdateDynamics(double dt)
  {
    ...
    ignition::math::Vector3d body_angular_velocity = pose.Rot().RotateVectorReverse(angular_velocity);
    ...
    tw.angular.x = body_angular_velocity.X();
    tw.angular.y = body_angular_velocity.Y();
    tw.angular.z = body_angular_velocity.Z();
